...
- [Feature matrix](feature-matrix.md) — coverage compared with the source apps.
...
- [Migration guides](migrations/) — adoption notes for , , ,
  and .
...
| Consumer adoption behavior | Relevant migration guide and example |
